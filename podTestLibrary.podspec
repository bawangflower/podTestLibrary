...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A test podTestLibrary.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/bawangflower/podTestLibrary'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'bawangflower' => 'flower258@dingtalk.com' }
  s.source           = { :git => 'https://github.com/bawangflower/podTestLibrary.git', :tag => "0.1.0" }
